...
from core.utils.caption import CaptionSequencer, finalize_caption, limit_caption_text
                ...
                try:
                    ...
                    # 处理result-generated事件
                        ...
                        if caption_enabled and text:
                            ...
                            segment_id = str(sentence_id) if sentence_id is not None else None
                            ...
                            if is_final:
                                ...
                                await send_display_message(
                                    conn,
                                    limit_caption_text(text, self.caption_partial_max_chars),
